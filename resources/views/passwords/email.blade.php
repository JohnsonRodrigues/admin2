...
@section('body')
    ...
    <div class="content">
        <!-- BEGIN LOGIN FORM -->
        <form class="forget-form" action="{{ url(config('metronic2.password_email_url', 'password/email')) }}"
              method="post">
            {!! csrf_field() !!}
            ...
            <div class="form-group">
                <button type="submit"
                        class="btn green btn-lg btn-block uppercase">{{ trans('metronic2::metronic2.send_password_reset_link') }}</button>
            </div>
...
@section('metronic2_js')
    ...
    <script src="{{ asset('vendor/metronic2/global/plugins/jquery-validation/js/jquery.validate.min.js')}}" type="text/javascript"></script>
