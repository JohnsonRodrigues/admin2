...
@section('body')
    ...
    <div class="content">
        ...
        <form class="register-form" action="{{ url(config('metronic2.register_url', 'register')) }}" method="post">
            {!! csrf_field() !!}
            <h3 class="form-title font-green">{{ trans('metronic2::metronic2.register') }}</h3>
            <p class="hint"> {{ trans('metronic2::metronic2.register_message') }}</p>
            <div class="form-group has-feedback {{ $errors->has('name') ? 'has-error' : '' }}">
                <label class="control-label visible-ie8 visible-ie9">{{ trans('metronic2::metronic2.full_name') }}</label>
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off"
                       placeholder="{{ trans('metronic2::metronic2.full_name') }}"
            ...
            <div class="form-group has-feedback {{ $errors->has('email') ? 'has-error' : '' }}">
                ...
                <input class="form-control placeholder-no-fix" type="text" autocomplete="off"
                       placeholder="{{ trans('metronic2::metronic2.email') }}"
            ...
            <div class="form-group">
                <button type="submit"
                        class="btn green btn-lg btn-block uppercase">{{ trans('metronic2::metronic2.register') }}</button>
            </div>
...
@section('metronic2_js')
    ...
    <script src="{{ asset('vendor/metronic2/pages/scripts/register.js')}}" type="text/javascript"></script>
